...
describe('SignUp component', () => {
  ...
  test('Should show name error if Validation fails', () => {
    ...
    Helper.testStatusForField(sut, 'name', validationError) // ta dando erro
  })
  ...
  test('Should show email error if Validation fails', () => {
    ...
    Helper.testStatusForField(sut, 'email', validationError) // ta dando erro
  })
  ...
  test('Should show password error if Validation fails', () => {
    ...
    Helper.testStatusForField(sut, 'password', validationError) // ta dando erro
  })
  ...
  test('Should show passwordConfirmation error if Validation fails', () => {
    ...
    Helper.testStatusForField(sut, 'passwordConfirmation', validationError) // ta dando erro
  })
  ...
  //     Helper.testErrorWrapChildCount(sut, 1) -> um elemento aparecendo, no caso o erro, o loading vai ficar escondido
  // })
  ...
  test('Should call SaveAccessToken on success', async () => {
    ...
    // expect(history.location.pathname).toBe('/') // ta dando erro // tem que ser redirecionado pra proxima  tela
  })
  ...
  test('Should present error is SaveAccessToken fails', async () => {
    ...
    await simulateValidSubmit(sut)
    // Helper.testElementText(sut, 'main-error', error.message) // onde tem main error??
  ...
  test('Should go to signup page', () => {
    ...
    // expect(history.action.length).toBe(1) // esse é pra ser hisotry.length
